...
@WebServlet(name = "GenericRemoveServlet", urlPatterns = {"/GenericRemoveServlet"})
public class GenericRemoveServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(parametros[0].split(":")[1]);
        
        ((CrowActionController)objectController).delete(((CrowActionController)objectController).getById(id));
